...
def main():       
    ...
    pfc.create_zone('ZONE_S1_ELLA_MAILLARD_1', 'Zone S1 Ella Maillard 1', ['AUTO', 'FORCE'],  ['Plafond', 'Bandeau'])
    pfc.create_zone('ZONE_S1_ELLA_MAILLARD_2', 'Zone S1 Ella Maillard 2', ['AUTO', 'FORCE', 'COCKTAIL'],  ['Plafond', 'Bandeau'])
